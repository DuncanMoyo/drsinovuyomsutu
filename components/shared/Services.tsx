...
const ServiceCard = ({ index, condition }: ServiceCardProps) => {
  return (
    <Tilt className="xs:w-[250px] w-full h-full bg-darkCoral rounded-full cursor-pointer">
      <motion.div
...
const Services = () => {
  return (
    ...
    >
      <div className="border-solid border-cedarChest mt-10 px-10 md:mx-96 border-2 rounded-lg text-center">
