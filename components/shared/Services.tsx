...
const Services = () => {
  return (
    <div id="two" className="h-full md:h-screen w-screen mx-auto max-w-7xl flex flex-col items-center mt-10 md:mb-20 pt-16 rounded-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-8 w-full px-10 mt-10 md:mt-20">
